...
def main(*args):
	...
	if new_input:
		print "Llamando al programa que resuelve el problema..."
		accionarMenu(f)
...
def mostrarMenu():
	...
	print "e - Aleatorio"
	print "f - Pasar a resolver algun archivo de entrada generado anteriormente"
	print "g - Salir del programa"
	opcion = raw_input("Ingrese una opcion [a-g]:  ")		
	return opcion
...
def accionarMenu(opcion):
	...
	'c': (randint(1,10), 1),
	'd': (randint(1,10), 0),
	'e': (randint(1,50), randint(0,49)),
	'f': os.system("./ejercicio_2 tests/*")
	}.get(opcion)
