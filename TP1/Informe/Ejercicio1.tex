...
En consecuencia, se puede afirmar que el algoritmo realiza a lo sumo $q.log_2$(n) operaciones en el peor caso; de donde sigue que la complejidad teórica del algoritmo es \Ode{log_2(n)}.
