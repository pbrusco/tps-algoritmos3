...
\restylealgo{boxed}
	...
	\BlankLine \BlankLine
	\textbf{Para} 1, ... , n/2 \{												\tcp*{\Ode{n^4 log(n)}}

	\BlankLine \BlankLine
	\tab cliqueAux $\leftarrow$ busquedaTabu(G, cliqueAux)			\tcp*{\Ode{n^3 log(n)}}
...
\restylealgo{boxed}
	...
	\BlankLine	
	\tab v $\leftarrow$ nodoConMenorGrado(TabuAgregados, cliqueTemp)				\tcp*{\Ode{n^2 log(n)}}
	...
	\tab vecindad $\leftarrow$ definirVecindad(TabuEliminados, cliqueTemp) 			\tcp*{\Ode{n^2 log(n)}}
