...
\restylealgo{boxed}
	...
	\BlankLine \BlankLine
	\textbf{Para} nodo en cliqueTemp \{		 							\tcp*{\Ode{n}}
	\tab \textbf{Si} (TabuAgregados[nodo] $\leq$ nro\_it) 				\tcp*{\Ode{1}}
	...
	\tab \textbf{Para} nodo en aux \{			 						\tcp*{\Ode{n}}
	\tab \tab \textbf{Si} (grado(G,nodo) $>$ nro\_it) 					\tcp*{\Ode{1}}
	\tab \tab \tab res $\leftarrow$ nodo								\tcp*{\Ode{1}}
	\tab \} \\
	\}
